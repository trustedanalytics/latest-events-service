...
public class EventsController {
    ...
    @ApiOperation(
            value = "Returns list of last events generated by other platform components",
            notes = "Privilege level: Consumer of this endpoint must be a member of the specified organization"
    )
    @ApiResponses(value = {
